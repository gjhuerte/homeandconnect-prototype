      ...
      <div class="col-md-5">
        ...
        <table class="table table-striped table-hover">
            ...
            <?php 
                ...
                $amount = "";
                $date = "";
                $result = MySqlQuery("SELECT * FROM tbl_billinginfo");
                ...
                for( $ctr = 0 ; $ctr < $rows ; ++$ctr){
                  ...
                  $date = sanitizeString(rows['duedate']);
                ...
                <tr>
                  ...
                  <td>$amount</td>
                  <td>$date</td>
                  <td><button class="btn btn-success btn-block btn-md">Use</button></td>
                </tr>
_END;
}
?>
          ...
          <div class="panel-body">
            ...
            <form action="payment.php" method="GET" class="form-group">
              <div class="fcol-sm-12 col-xs-12">
                ...
                <div class="col-sm-2">
                  <p class="form-control-static" name="billingid">0000000</p>
                </div>
              </div>
