...
_NOTFOUND_ALERT;
      ...
      else
      {
        ...
        die('<script>window.location.href = "rent.php";</script>');
      }
    }
  ...
  echo <<<_RENT
      <form method="GET">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <label class="col-sm-5 control-label" hidden>Tenant ID:</label>
            <div class="col-sm-2">
            <p class="form-control-static" name="tenantid" hidden>$id</p>
            </div>
