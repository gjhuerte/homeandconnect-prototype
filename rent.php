          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Assign to property</a></li>
...
<?php
  ...
  {  
      ...
      $result = MySqlQuery("SELECT * FROM tbl_personalinfo left join tbl_user on id = userinfo WHERE lname REGEXP '$name' or fname REGEXP '$name' or mname REGEXP '$name' AND type = '2' LIMIT 2");
...
_NOTFOUND_ALERT;
      ...
      else
      {
        MySqlQuery("call sproc_rent('$id','$unitno', '$amount');");
         die("<script>alert('Property Rented!');window.location.href = 'rent.php';</script>");
      }
    }
