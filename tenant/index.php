      ...
      ?>
         ...
         <div class="col-md-8">
            <?php
              ...
              <div class="col-md-4">
                <form method="POST">
                <div class="panel panel-$type panel-padding" data-toggle="modal" data-target="#propertyinfomodal" name="housedescinfo">
                  <div class="panel-heading">
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          ...
          <div class="modal-footer">
            <button type="submit" class="col-md-push-2 col-md-5 btn btn-success btn-lg" name="rentbutton">Rent</button>
