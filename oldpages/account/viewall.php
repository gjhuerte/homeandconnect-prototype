  ...
  if($id!= "")
    echo <<<_END
          <tr>
            ...
            <td><button class="btn btn-warning" name="editbutton" data-target="#addnewtenantmodal" data-toggle="modal">Edit</button>
            <button class="btn btn-danger" name="removebutton">Remove</button></td>
          </tr>
_END;
  }
    echo <<<_END
  ...
  {  
      ...
      if($username == "" || $password == "" || $lastname == "" ||$firstname == "" ||$middlename == "" ||$birthdate == "" ||$email == "" ||$telno == "" ||$gender == ""){
        ...
        if($result->num_rows){
          ...
          echo "<script>alert('Account Information Updated!');window.location.href = 'viewall.php';</script>";
        }
      }
    ...
    echo <<<_END
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="$buttonname">Submit</button>
